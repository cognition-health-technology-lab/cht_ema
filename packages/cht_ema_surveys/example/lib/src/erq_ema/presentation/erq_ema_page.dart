...
class ErqEmaSurveyPage extends StatelessWidget {
  ...
  final void Function(
    List<ErqEmaItemResponse> responses,
    RPTaskResult rawResult,
  )?
  onSubmit;

  const ErqEmaSurveyPage({required this.onFinish, this.onSubmit, super.key});
    ...
    return Theme(
      ...
      child: RPUITask(
        ...
        onSubmit: (RPTaskResult result) {
          final responses = parseErqEmaResponses(result);
